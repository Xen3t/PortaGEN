...
// —————————————————————————————————————————————— page
export default function GenerationApp({ isAdmin }: { isAdmin: boolean }) {
  ...
  useEffect(() => {
    ...
    // MES Libre réservé aux admins (21/08) : le lien direct est ignoré aussi.
    else if (m === 'libre' && isAdmin) pickMode('lib')
  ...
  function pickMode(m: Mode) {
    // MES Libre réservé aux admins (demande Mathias 21/08).
    if (m === 'lib' && !isAdmin) return
    setMode(m)
      ...
      {!sessionLoading && view === 'mode' && (
        <section className="animate-fade-in-up">
          ...
          >
            ...
            {/* MES Libre : carte réservée aux ADMINS (demande Mathias 21/08) —
                les routes /api/generation/libre/* sont verrouillées aussi. */}
            {isAdmin && (
            <button
